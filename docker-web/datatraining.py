...
tbCallBack = keras.callbacks.TensorBoard(log_dir='./model/tensorboard-save/tensorboard-default'+timestr, histogram_freq=0, write_graph=True, write_images=True)
...
with open("model/model-save/model-default"+timestr+".json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("model/model-save/model-default"+timestr+".h5")
